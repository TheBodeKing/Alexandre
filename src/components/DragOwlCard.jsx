  ...
  return (
    <div className="w-[277.5px] touch-pan-y group">
      <div className="flex flex-col relative gap-[40px] py-[20px] px-[10px] ">
        <div
          className="shadow-[0px_0px_10px_1px_#00000054] group-hover:shadow-[0px_0px_16px_2px_#00000054]
         rounded-sm h-[320px] bg-white transition-all duration-600 overflow-hidden group-hover:-translate-y-2"
        >
